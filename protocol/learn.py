...
      domainalgo = self.getAlgorithm(problem, "Domain")
...
      for test in test_ids:
         ...
         for checkpoint in checkpoints:
             ...
             toolset["Network"] = estimatoralgo.execute(toolset, "DomainAdaptTraining" )
             toolset["TestDataSet"] = self.getTestDataSet(test)
